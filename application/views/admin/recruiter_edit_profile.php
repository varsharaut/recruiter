                ...
                <div class="container-fluid">
                    <div id="contentwrapper">
                        <div id="content">
                            ...
                            <?php } ?>
                            <form method="post" action="<?=site_url('admin/recruiter_edit')?>">
                                <!-- main content -->
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="box_a">
                                            ...
                                            <div class="box_a_content cnt_a">
                                                <!-- <div class="row-fluid">
                                                    <div class="span4 clearfix">
                                                        ...
                                                        <input type="text" id="recruiter_name" class="span12" name="recruiter_name" value="<?=$recruiterData[0]['recruiter_name']?>">
                                                    </div>
                                                    <div class="span4 clearfix">
                                                        <h4 class="heading_b">Designation</h4>
                                                        <input type="text" id="designation" class="span12" name="designation" value="<?=$recruiterData[0]['designation']?>">
                                                    </div>
                                                    <div class="span4 clearfix">
                                                        <h4 class="heading_b">Contact No.</h4>
                                                        <input type="text" id="mobile" class="span12" name="mobile" value="<?=$recruiterData[0]['mobile']?>" >
                                                    </div>
                                                </div> -->
                                                <input type="hidden" name="" value="<?=$recruiterData[0]['id']?>">
                                                <div class="row-fluid">
                                                    <div class="span4 clearfix">
                                                        <h4 class="heading_b">Mail ID</h4>
                                                        <input type="email" id="mailid" class="span12" name="mailid" required value="<?=$recruiterData[0]['mailid']?>">
                                                    </div>
                                                    <div class="span4 clearfix">
                                                        <h4 class="heading_b">Username</h4>
                                                        <input type="text" id="username" class="span12" name="username" required value="<?=$recruiterData[0]['username']?>">
                                                    </div>
                                                    <div class="span4 clearfix">
