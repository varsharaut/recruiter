                                                    ...
                                                    <div class="tabbable tabbable-bordered">
                                                        ...
                                                        <div class="tab-content">
                                                            <div id="tbp_a" class="tab-pane active">
                                                                ...
                                                                <?=ucfirst($interschedule[0]['candidate_name'])?></p>
                                                                <p class="formSep"><small class="muted">Company Name:</small> <?=ucwords($interschedule[0]['company_name'][0]['company_name'])?></p>
                                                                <p class="formSep"><small class="muted">Position:</small> <?=$interschedule[0]['position']?></p>
                                                                <p class="formSep"><small class="muted">Mobile No.:</small> <?=$interschedule[0]['contact_no']?></p>
                                                                <p class="formSep"><small class="muted">Email ID:</small> <?=$interschedule[0]['emailid']?></p>
                                                                <p class="formSep"><small class="muted">Current Salary:</small> <?=$interschedule[0]['current_salary']?></p>
                                                                <p class="formSep"><small class="muted">Expected Salary:</small> <?=$interschedule[0]['expected_salary']?></p>
                                                                <p class="formSep"><small class="muted">Noticed Period:</small> <?=$interschedule[0]['noticed_period']?></p>
                                                                <p class="formSep"><small class="muted">CV: </small><a href='<?=base_url()."cv/".$interschedule[0]["cv"]?>'>Download</a></p>
                                                                
                                                            </div>
                                                            <div id="tbp_b" class="tab-pane">
                                                                <p class="formSep"><small class="muted">Round: </small>First Round</p>
                                                                <p class="formSep"><small class="muted">Date:</small> <?php if($interschedule[0]['f-date'] != null){echo date("jS F, Y",strtotime($interschedule[0]['f-date']));}else{}?></p>
                                                                <p class="formSep"><small class="muted">Time:</small> <?=$interschedule[0]['f-time']?></p>
                                                                <p class="formSep"><small class="muted">Status:</small> 
                                                                <?php if($interschedule[0]['f-status'] == null){}else{print_r($interschedule[0]['f-status'][0]['status']);}?></p>
                                                            </div>
                                                            <div id="tbp_c" class="tab-pane">
                                                                <p class="formSep"><small class="muted">Round: </small>Second Round</p>
                                                                <p class="formSep"><small class="muted">Date:</small> <?php if($interschedule[0]['s-date'] != null){echo date("jS F, Y",strtotime($interschedule[0]['s-date']));}else{}?></p>
                                                                <p class="formSep"><small class="muted">Time:</small> <?=$interschedule[0]['s-time']?></p>
                                                                <p class="formSep"><small class="muted">Status:</small> 
                                                                <?php if($interschedule[0]['s-status'] == null){}else{print_r($interschedule[0]['s-status'][0]['status']);}?></p>
                                                            </div>
                                                            <div id="tbp_d" class="tab-pane">
                                                                <p class="formSep"><small class="muted">Round: </small>Third Round</p>
                                                                <p class="formSep"><small class="muted">Date:</small> <?php if($interschedule[0]['t-date'] != null){echo date("jS F, Y",strtotime($interschedule[0]['t-date']));}else{}?></p>
                                                                <p class="formSep"><small class="muted">Time:</small> <?=$interschedule[0]['t-time']?></p>
                                                                <p class="formSep"><small class="muted">Status:</small> 
                                                                <?php if($interschedule[0]['t-status'] == null){}else{print_r($interschedule[0]['t-status'][0]['status']);}?></p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
