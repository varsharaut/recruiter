                        ...
                        <div id="content">
                            ...
                            <section id="breadcrumbs">
                                <ul>
                                    ...
                                    <li class="crumb_sep"><i class="elusive-icon-play"></i></li>
                                    <li><span>Recruiter List</span></li>                                    
                                </ul>
                            </section>
                                    ...
                                    <div class="box_a">
                                        ...
                                        <div class="box_a_content">
                                            <table id="dt_basic" class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php $i=1; foreach($recruiterData as $data) {?>
                                                    <tr>
                                                        <td><?=$i++?></td>
                                                        ...
                                                        <td><?=$data['mobile']?></td>
                                                        <td><?=$data['mailid']?></td>
                                                        <td><a href="<?=site_url('admin/recruiter_edit_profile/').$data['id']?>"><button class="btn btn-info">Reset Password</button></td>
                                                    </tr>
                                                    <?php }?>
                                                </tbody>
                                            </table>
