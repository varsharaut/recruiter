                ...
                <div class="container-fluid">
                    <div id="contentwrapper">
                        <div id="content">
                            ...
                            <?php } ?>
                            <form method="post" action="<?=site_url('admin/addeditposition')?>" enctype="multipart/form-data">
                                <!-- main content -->
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="box_a">
                                            ...
                                            <input type="hidden" name="id" value="<?=$positionprofile[0]['id']?>" >
                                            <div class="box_a_content cnt_a">
                                                <div class="row-fluid">
                                                    <div class="span3 clearfix">
                                                        <h4 class="heading_b">Comapany Name</h4>
                                                        <input type="text" id="company_id" class="span12"  value="<?=$positionprofile[0]['company_name'][0]['company_name']?>" > 
                                                        <input type="hidden" value="<?=$positionprofile[0]['company_name'][0]['id']?>" name="company_id" >
                                                        <!-- <a href="" class="btn btn-info" class="span3">Change</a> -->
                                                        <div class="company_id1" style="display: none" >
                                                            <select name="company_id1" class="span10" id="company_id1" >
                                                    ...
                                                    <div class="span3 clearfix">
                                                        ...
                                                        <input type="text" id="position_title" class="span12" name="position_title" required value="<?=$positionprofile[0]['position_title']?>">
                                                    </div>
                                                    <div class="span3 clearfix">
                                                        <h4 class="heading_b">Experience</h4>
                                                        <input type="text" id="experience" class="span12" name="experience" required value="<?=$positionprofile[0]['experience']?>">
                                                    </div>
                                                    <div class="span3 clearfix">
                                                        <h4 class="heading_b">Salary Range</h4>
                                                        <input type="text" id="salary_range" class="span12" name="salary_range" required value="<?=$positionprofile[0]['salary_range']?>">
                                                    </div>
                                                </div>
                                                <div class="row-fluid">
                                                    ...
                                                    <div class="span3 clearfix">
                                                        ...
                                                        <input type="text" id="no_of_position" class="span12" name="no_of_position" required value="<?=$positionprofile[0]['no_of_position']?>">
                                                    </div>
                                                    <div class="span3 clearfix">
                                                        <h4 class="heading_b">Status of the Position</h4>
                                                        <input type="hidden" name="status_of_position" value="<?=ucfirst($positionprofile[0]['status_of_position'][0]['id'])?>" class="span12 ">
                                                        <input type="text" name="" value="<?=ucfirst($positionprofile[0]['status_of_position'][0]['name'])?>" class="span12 status_of_position">
                                                        <div class="position" style="display: none">
                                                            <select class="span10 status_of_position1" name="status_of_position1">
                                                                <option value="">Select</option>
                                                                <?php foreach ($position_status as $position_status): ?>
                                                                    <option value="<?=$position_status['id']?>"><?=$position_status['name']?></option>
                                                                <?php endforeach ?>
                                                            </select>
                                                            <a href="" class="reset1">Reset</a>
                                                        </div>
                                                    </div>
                                                    <div class="span3 clearfix">
                                                        <h4 class="heading_b">Industry</h4>
                                                        <input type="hidden" name="industry" class="span12" value="<?=ucfirst($positionprofile[0]['industry'][0]['id'])?>">
                                                        <input type="text" name="" class="span12 industry" value="<?=ucfirst($positionprofile[0]['industry'][0]['name'])?>">
                                                        <div class="industry1" style="display: none">
                                                            <select name="industry1" class="span10">
                                                                <option value="">Select</option>
                                                    ...
                                                    <div class="span3 clearfix">
                                                        ...
                                                        <input class="span12 date_opened" type="text" name="date_opened" value="<?=$positionprofile[0]['date_opened']?>">
                                                        <div class="date_opened1" style="display: none">
                                                            <div class="input-append date bs_datepicker" data-date-format="dd-mm-yyyy">
                                                                <input class="span12" type="text" name="date_opened1">
                                                ...
                                                <div class="row-fluid">
                                                    ...
                                                    <div>
                                                        <div class="span2 clearfix">
                                                            ...
                                                            <input type="text" name="jd" class="jd span12" value="<?=$positionprofile[0]['jd']?>">
                                                            <span>
                                                            <select class="span12 jd1" name="jd1" style="display: none">
                                                                <option value="">Select</option>
                                                                <option value="Yes">Yes</option>
                                                                <option value="No">No</option>
                                                            </select>
                                                            <a href="" class="reset2" style="display: none">Reset</a>
                                                        </div>
                                                    ...
                                                    <div class="span3 clearfix">
                                                        ...
                                                        <input type="text" name="" value="<?=ucwords($positionprofile[0]['recruiter_name'])?>" class="span12 recruiter" >  

                                                        <input type="hidden" name="assign_to_recruiter" value="<?=$positionprofile[0]['recruiter_id']?>" >
                                                        <div style="display: none;" id="assign_to_recruiter1">                       
                                                           <select name="assign_to_recruiter1[]"  class="span10" multiple="multiple">
                                                                <option value="">Select</option>
                                                    ...
                                                    <div class="span4 clearfix">
                                                        ...
                                                        <!-- <textarea type="text" id="client_requirement" class="span12" name="" value="<?=$positionprofile[0]['client_requirement']?>" required></textarea> -->
                                                        <input type="text" name="client_requirement" value="<?=$positionprofile[0]['client_requirement']?>" class="span12">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="box_a_content cnt_a">
                                                <div class="row-fluid">
                                                    <div class="span6 clearfix">
                                                        ...
                                                        <input type="text" id="remark_client" class="span12" name=" remark_client" rows="4" value="<?=$positionprofile[0]['remark_client']?>">
                                                    </div>
                                                    <div class="span6 clearfix">
                                                        <h4 class="heading_b">Remark from Recruiter</h4>
                                                        <input type="text" id="remark_recruiter" class="span12" name="remark_recruiter" rows="4" value="<?=$positionprofile[0]['remark_recruiter']?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    // function companynameget(){
    //     alert('hhh');
    //     // $.post('<?=site_url('admin/getcompanyname')?>',function(data){
    //     //     alert(data)
    ...
    //             alert(data.id);
    //              appenddata = "<option value = '" + data[i].id + " '>" + data[i].company_name + " </option>";
    //             $('#compant_id').append(appenddata);
    //             $()
    //         }
    //     // });
    // }
...
<!-- WYSIWG Editor -->
    ...
    <script>
        $('#company_id').on('click', function(){
            $.post('<?=site_url('admin/getcompanyname')?>',function(data){ 
                ...
                for (var i = 0; i < new_var.length;  i++) {
                    console.log(new_var[i].company_name);
                    var appenddata = "<option value = '" + new_var[i].id + " '>" + new_var[i].company_name + " </option>";
                    $('#company_id1').append(appenddata);
                }
            });
            $('#company_id').hide();
            $('.company_id1').show();
        ...
        $('.status_of_position').on('click',function(){
            $('.position').show();
            $('.status_of_position').hide();
        });
        $('.date_opened').on('click',function(){
            $('.date_opened1').show();
            $('.date_opened').hide();
        });
        ...
        $('.reset1').on('click',function(){
            $('.position').hide();
            $('.status_of_position').show();
        });
        $('.jd1').on('click', function(){
            if($('.jd1').val()=='Yes'){
                $('.file').show();
                $('.reset2').show();
            }else{
        ...
        $('.recruiter').on('click',function(){
            $('#assign_to_recruiter1').show();
            $('.recruiter').hide();
        });
        $('.reset3').on('click',function(){
            $('#assign_to_recruiter1').hide();
            $('.recruiter').show();
        });
    </script>
