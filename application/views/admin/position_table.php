                                    ...
                                    <div class="box_a">
                                        ...
                                        <div class="box_a_content">
                                            <table id="dt_basic" class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php $i=1; foreach($positionTableData as $data) {?>
                                                    <tr>
                                                        <td><?=$i++?></td>
                                                        <td><a href="<?=site_url('admin/position_profile/').$data['id']?>"><?=ucwords($data['company_name'][0]['company_name'])?></a></td>
                                                        <td><?=ucwords($data['position_title'])?></td>
                                                        <td><?=$data['experience']?></td>
                                                        <td><?=$data['no_of_position']?></td>
                                                        <td><?=$data['status_of_position']?></td>
                                                        <td><?=ucwords($data['recruiter_name'])?></td>
                                                        <td><a href="<?=site_url('admin/position_edit_profile/').$data['id']?>"><i class="elusive-icon-pencil"></i></a><a onclick="return confirm('Are you sure you want to delete ..??')" href="<?=site_url('admin/position_delete/').$data['id']?>"><i class="elusive-icon-trash"></i></a></td>
                                                        <td><?php $inactive = $data['active']; if($inactive == 1){ ?><a class="btn btn-info" href="<?=site_url('admin/position_active/').$data['id']?>">Active</a><?php } else {?><a class="btn btn-info" href="<?=site_url('admin/position_inactive/').$data['id']?>">Inactive</a><?php }?></td>
                                                    </tr>
                                                    <?php }?>
                                                </tbody>
                                            </table>
