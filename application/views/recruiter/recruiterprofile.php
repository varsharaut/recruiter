                        ...
                        <div id="content">
                            ...
                            <section id="breadcrumbs">
                                <ul>
                                    ...
                                    <li><a href="#">Recruiter Manager</a></li>
                                    <li class="crumb_sep"><i class="elusive-icon-play"></i></li>
                                    <li><span>Recruiter Profile</span></li>                                    
                                </ul>
                            </section>
                            ...
                            <?php } ?>
                            <form method="post" action="<?=site_url('recruiter/updateRecruiterProfile')?>">
                                <!-- main content -->
                                <div class="row-fluid">
                                    <div class="span12">
                                        <div class="box_a">
                                            ...
                                            <input type="hidden" name="id" value="<?=$recruiterprofile[0]['id']?>">
                                            <div class="box_a_content cnt_a">
                                                <div class="row-fluid">
                                                    <div class="span4 clearfix">
                                                        <h4 class="heading_b">Recruiter Name</h4>
                                                        <input type="text" id="recruiter_name" class="span12" name="recruiter_name" value="<?=$recruiterprofile[0]['recruiter_name']?>">
                                                    </div>
                                                    <div class="span4 clearfix">
                                                        <h4 class="heading_b">Designation</h4>
                                                        <input type="text" id="designation" class="span12" name="designation" value="<?=$recruiterprofile[0]['designation']?>">
                                                    </div>
                                                    <div class="span4 clearfix">
                                                        <h4 class="heading_b">Contact No.</h4>
                                                        <input type="text" id="mobile" class="span12" name="mobile" value="<?=$recruiterprofile[0]['mobile']?>" pattern="[7-9]{1}[0-9]{9}">
                                                    </div>
                                                </div>
                                                <div class="row-fluid">
                                                    <div class="span4 clearfix">
                                                        <h4 class="heading_b">Mail ID</h4>
                                                        <input type="email" id="mailid" class="span12" name="mailid" required value="<?=$recruiterprofile[0]['mailid']?>">
                                                    </div>
                                                    <div class="span4 clearfix" style="display: none">
                                                        <h4 class="heading_b">Username</h4>
                                                        <input type="text" id="username" class="span12" name="username" readonly value="<?=$recruiterprofile[0]['username']?>">
                                                    </div>
                                                    <div class="span4 clearfix" style="display: none">
                                                        <h4 class="heading_b">Password</h4>
                                                        <input type="text" id="password" class="span12" name="password" readonly value="<?=$recruiterprofile[0]['password']?>">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
