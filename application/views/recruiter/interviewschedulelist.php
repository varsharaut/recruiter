                                    ...
                                    <div class="box_a">
                                        ...
                                        <div class="box_a_content">
                                            <table id="dt_basic" class="table table-striped">
                                                ...
                                                <tbody>
                                                    <?php $i=1; foreach($interviewschedule as $data) {?>
                                                    <tr>
                                                        <td><?=$i++?></td>
                                                        <td><a href="<?=site_url('recruiter/interviewscheduleprofile/').$data['id']?>"><?=ucwords($data['company_name'][0]['company_name'])?></a></td>
                                                        <td><?=ucwords($data['candidate_name'])?></td>
